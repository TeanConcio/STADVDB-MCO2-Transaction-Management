...
-- -----------------------------------------------------
-- Schema STADVDB-MCO2-VisMin
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `STADVDB-MCO2-VisMin` ;

-- -----------------------------------------------------
-- Schema STADVDB-MCO2-VisMin
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `STADVDB-MCO2-VisMin` ;
USE `STADVDB-MCO2-VisMin` ;

-- -----------------------------------------------------
-- Table `STADVDB-MCO2-VisMin`.`appointments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `STADVDB-MCO2-VisMin`.`appointments` ;

CREATE TABLE IF NOT EXISTS `STADVDB-MCO2-VisMin`.`appointments` (
  `apt_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `STADVDB-MCO2-VisMin`.`vismin_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `STADVDB-MCO2-VisMin`.`vismin_log` ;

CREATE TABLE IF NOT EXISTS `STADVDB-MCO2-VisMin`.`vismin_log` (
  ...
  `dcotor_specialty` VARCHAR(64) NULL,
