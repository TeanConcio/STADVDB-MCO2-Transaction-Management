...
-- -----------------------------------------------------
-- Schema STADVDB-MCO2-Luzon
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `STADVDB-MCO2-Luzon` ;

-- -----------------------------------------------------
-- Schema STADVDB-MCO2-Luzon
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `STADVDB-MCO2-Luzon` ;
USE `STADVDB-MCO2-Luzon` ;

-- -----------------------------------------------------
-- Table `STADVDB-MCO2-Luzon`.`appointments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `STADVDB-MCO2-Luzon`.`appointments` ;

CREATE TABLE IF NOT EXISTS `STADVDB-MCO2-Luzon`.`appointments` (
  `apt_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `STADVDB-MCO2-Luzon`.`luzon_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `STADVDB-MCO2-Luzon`.`luzon_log` ;

CREATE TABLE IF NOT EXISTS `STADVDB-MCO2-Luzon`.`luzon_log` (
